...
{
    public partial class hospital_rnwaContext : DbContext
    {
        public hospital_rnwaContext()
        {
        }

        public hospital_rnwaContext(DbContextOptions<hospital_rnwaContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySQL("Server=localhost;Database=hospital_rnwa;Uid=root;Pwd=+venY/6%+^PW");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AffiliatedWith>(entity =>
            {
                ...
                entity.Property(e => e.PrimaryAffiliation).HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity<Appointment>(entity =>
            {
                ...
                entity.Property(e => e.ExaminationRoom).IsRequired();

                entity.Property(e => e.Patient).HasColumnType("int(11)");

                entity.Property(e => e.Physician).HasColumnType("int(11)");

                entity.Property(e => e.PrepNurse)
                    .HasColumnType("int(11)")
            ...
            modelBuilder.Entity<Nurse>(entity =>
            {
                ...
                entity.Property(e => e.Registered).HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity<Room>(entity =>
            {
                ...
                entity.Property(e => e.Unavailable).HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity<Undergoes>(entity =>
            {
                ...
                entity.Property(e => e.AssistingNurse)
                    .HasColumnType("int(11)")
                    .HasDefaultValueSql("'NULL'");
